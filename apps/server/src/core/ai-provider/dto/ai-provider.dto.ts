...
> = {
  mimo: { name: '小米 MiMo', baseUrl: 'https://api.xiaomi.com/mimo', modelName: 'mimo-7b' },
  openai: { name: 'OpenAI', baseUrl: 'https://api.openai.com/v1', modelName: 'gpt-4o' },
  gemini: { name: 'Google Gemini', baseUrl: 'https://generativelanguage.googleapis.com/v1beta', modelName: 'gemini-pro' },
  ollama: { name: 'Ollama (本地)', baseUrl: 'http://localhost:11434', modelName: 'llama3' },
  claude: { name: 'Claude (官方)', baseUrl: 'https://api.anthropic.com/v1', modelName: 'claude-3-sonnet-20240229' },
